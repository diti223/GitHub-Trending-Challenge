        ...
        ScrollView {
            VStack(alignment: .leading) {
                VStack(alignment: .leading, spacing: 10) {
                    ...
                    HStack {
                        ImageWrapper(url: repository.author.avatarURL)
                    ...
                    SwiftUI.Text(repository.description)
                    HStack(spacing: 14) {
                        HStack {
                            Image(systemName: "star")
                                .foregroundColor(.gray)
                            
                            SwiftUI.Text(repository.starsCountDescription)
                            SwiftUI.Text("stars")
                                .foregroundColor(.gray)
                        }
                        ...
                        HStack {
                            Image(systemName: "arrow.triangle.branch")
                                .foregroundColor(.gray)
                            SwiftUI.Text(repository.forksCountDescription)
                            SwiftUI.Text("forks")
                                .foregroundColor(.gray)
                        }
                    }
...
struct RepositoryDetailView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            RepositoryDetailView(viewModel: RepositoryViewModel(repository: .preview1, httpClient: HTTPClient(session: .shared)))
        }
    }
}

extension Repository {
    static let preview1 =  Repository(id: "abc", description: "This is a very long description", name: "bun", author: .user1, contributors: [.user1, .user2], starsCount: 15_200, watchersCount: 486, cloneURL: URL(string: "https://apple.com")!, languages: ["Swift", "Objective-C"], created: Date(), updated: Date(), isFork: true, forksCount: 42, license: .apache, defaultBranch: "main")
}

extension User {
    static var user1: User {
        User(username: "Jarred-Sumner", avatarURL: URL(string: "https://pbs.twimg.com/profile_images/1494251948782067714/8rYsP-Td_400x400.jpg")!, profileURL: URL(string: "https://avatars.githubusercontent.com/u/3709715?v=4")!)
    }
    static var user2: User {
        User(username: "john.doe", avatarURL: URL(string: "https://pbs.twimg.com/profile_images/1500170386520129536/Rr2G6A-N_400x400.jpg")!, profileURL: URL(string: "https://pbs.twimg.com/profile_images/1500170386520129536/Rr2G6A-N_400x400.jpg")!)
    }
}


extension String {
    static let readmeSample =
    """
# SwiftLint
